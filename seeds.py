...
def seed_regular_payments():
    with get_db() as conn:
        ...
        if existing == 0:
            examples = [
                (3500000, "2024-01-05", "ЖКХ", "Квартплата", "monthly", ""),
                (800000, "2024-01-15", "ЖКХ", "Электричество", "monthly", ""),
                (90000, "2024-01-20", "Связь", "Интернет", "monthly", ""),
                (30000, "2024-01-01", "Связь", "VPN", "monthly", ""),
                (60000, "2024-01-10", "Связь", "Мобильная связь", "monthly", ""),
                (50000, "2024-01-25", "Подписки", "", "monthly", ""),
            ]
